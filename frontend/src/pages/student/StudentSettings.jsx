    ...
    return (
        <div className="space-y-8">
            ...
            <section className="relative animate-fade-in-scale">
                <div className="bg-[#c799ff]/10 backdrop-blur-2xl p-8 rounded-[32px] ring-1 ring-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.3)] flex flex-col items-center text-center">
                    {/* Profile Picture with gradient glow */}
                    <div className="relative mb-4">
                        <div className="absolute -inset-1 bg-gradient-to-tr from-[#c799ff] to-[#4af8e3] rounded-full blur-sm opacity-50" />
                    ...
                    <div className="mt-6 flex gap-2 flex-wrap justify-center">
                        ...
                        <span className="px-3 py-1 bg-[#bc87fe]/20 text-[#ba85fb] text-[10px] font-bold uppercase tracking-widest rounded-full ring-1 ring-[#c799ff]/20">
                            Premium Tier
                        </span>
                    </div>
                </div>
            ...
            <section className="space-y-3 animate-fade-in-scale" style={{ animationDelay: "100ms" }}>
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl group-hover:bg-[#c799ff]/20 transition-colors">
                            <span className="material-symbols-outlined text-[#ba85fb]">photo_camera</span>
                        </div>
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl group-hover:bg-[#c799ff]/20 transition-colors">
                            <span className="material-symbols-outlined text-[#ba85fb]">person</span>
                        </div>
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl group-hover:bg-[#c799ff]/20 transition-colors">
                            <span className="material-symbols-outlined text-[#ba85fb]">lock</span>
                        </div>
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl group-hover:bg-[#c799ff]/20 transition-colors">
                            <span className="material-symbols-outlined text-[#ba85fb]">devices</span>
                        </div>
                ...
                <div className="w-full flex items-center justify-between p-4 bg-[#11131d]/60 backdrop-blur-md rounded-2xl">
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl">
                            <span className="material-symbols-outlined text-[#ba85fb]">notifications</span>
                        </div>
                ...
                <div className="w-full flex items-center justify-between p-4 bg-[#11131d]/60 backdrop-blur-md rounded-2xl">
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl">
                            <span className="material-symbols-outlined text-[#ba85fb]">dark_mode</span>
                        </div>
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl group-hover:bg-[#c799ff]/20 transition-colors">
                            <span className="material-symbols-outlined text-[#ba85fb]">support_agent</span>
                        </div>
                    ...
                    <div className="w-full max-w-sm mx-4 bg-[#0c0e17] border border-white/10 rounded-[32px] shadow-2xl p-6 animate-fade-in-scale" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleUsernameSubmit}>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-2xl bg-white/[0.03] border border-white/10 text-[#f0f0fd] text-sm focus:outline-none focus:ring-2 focus:ring-[#c799ff]/50 mb-4 placeholder:text-[#737580]"
                            />
                            <div className="flex gap-2">
                                ...
                                <button type="submit" disabled={credLoading}
                                    className="flex-1 px-4 py-3 rounded-full bg-[#c799ff] text-[#440080] text-sm font-bold hover:bg-[#ba85fb] transition-all disabled:opacity-50 cursor-pointer shadow-[0_4px_20px_rgba(199,153,255,0.3)]">
                    ...
                    <div className="w-full max-w-sm mx-4 bg-[#0c0e17] border border-white/10 rounded-[32px] shadow-2xl p-6 animate-fade-in-scale" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handlePasswordSubmit}>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-2xl bg-white/[0.03] border border-white/10 text-[#f0f0fd] text-sm focus:outline-none focus:ring-2 focus:ring-[#c799ff]/50 mb-3 placeholder:text-[#737580]"
                            />
